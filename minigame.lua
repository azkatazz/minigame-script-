...
local SC = game.Players.LocalPlayer.PlayerGui.Race.Container
...
local function autoJump()
    while true do
       ...
       SC.Minigame:TweenPosition(UDim2.new(0.221, 0, 0.221, 0)) 
       humanoid:ChangeState(Enum.HumanoidStateType.Jumping) -- Mengubah status menjadi melompat
